...
export function Hero() {
  return (
    <section id="top" className="relative min-h-[calc(100dvh-3.75rem)] overflow-hidden">
      <img
        src={heroImage}
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100dvh-3.75rem)] max-w-[1400px] flex-col px-6 pt-24 pb-8 md:px-10 md:pb-10">
